...
function imageShowcase(
  ...
  if (layout === "single-cover") {
    return (
      <div className="relative h-full overflow-hidden rounded-[24px] border border-white/10 bg-black/35 p-2.5 sm:p-3">
        <div
    ...
    return (
      <div className="grid h-full gap-3 sm:gap-4 md:grid-cols-2">
        {images.slice(0, 2).map((image, index) => (
          <div
            key={image.src}
            className="relative min-h-0 overflow-hidden rounded-[24px] border border-white/10 bg-black/35 p-2.5 sm:p-3"
          >
            <div
  ...
  if (layout === "stacked") {
    return (
      <div className="grid h-full min-h-0 gap-3 sm:gap-4 grid-rows-[1.2fr_0.8fr]">
  ...
  return (
    <div className="grid h-full gap-3 sm:gap-4 lg:grid-cols-[0.72fr_1.28fr]">
      <div className="relative min-h-[8.5rem] overflow-hidden rounded-[24px] border border-white/10 bg-black/35 p-2.5 sm:p-3">
        <div
          className="absolute inset-0 opacity-42"
          style={{
      ...
      <div className="relative min-h-[10.5rem] overflow-hidden rounded-[24px] border border-white/10 bg-black/35 p-2.5 sm:p-3">
        {imageFrame({
          src: images[1]?.src ?? images[0]?.src ?? "",
          alt: images[1]?.alt ?? images[0]?.alt ?? "",
        })}
        <div className="absolute inset-x-3 bottom-3 rounded-full border border-white/10 bg-black/45 px-3 py-2 text-[9px] uppercase tracking-[0.22em] text-white/60 backdrop-blur-xl sm:inset-x-6 sm:bottom-6 sm:px-4 sm:py-3 sm:text-[10px] sm:tracking-[0.26em]">
